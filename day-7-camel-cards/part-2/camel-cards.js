...
function calculateHandStrength(hand) {
    ...
    if (cardsWithAmount.length === 5) {
        result = 1;
        if (cards.includes("J")) {
            // console.log("Upgraded to pair:", hand)
            result = 2;
        }
    }
    ...
    if (cardsWithAmount.length === 4) {
        ...
        if (cards.includes("J")) { // can be upgraded to three of a kind
            // console.log("Upgraded to three of a kind:", hand)
            result = 4;
        }
    }

    // three of a kind or two pair TKJTT
    ...
    if (cardsWithAmount.length === 3) {
        ...
        if (cards.includes("J")) {
            if (result === 4) { // three of a kind can be upgraded to four of a kind
                result = 6;
            } else {
                let found = cardsWithAmount.find(cwa => cwa.card === "J");
                if (found.amount === 2) {
                    result = 6; // two pair, of which 2 cards are a J can be upgraded to four of a kind
                } else {
                    result = 5;
                }
            }
    ...
    if (cardsWithAmount.length === 2) {
        ...
        // if either one is a jack it can be upgraded to five of a kind
        if (cards.includes("J")) {
            result = 7;
        }
    }
